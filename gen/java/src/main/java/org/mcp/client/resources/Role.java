 ...
 * </pre>
 *
 * Protobuf enum {@code mcp.client.v1.Role}
 */
public enum Role
   ...
   * </pre>
   *
   * <code>ROLE_USER = 1 [(.mcp.client.v1.string_name) = "user"];</code>
   */
  ROLE_USER(1),
  /**
   * <pre>
   ...
   * </pre>
   *
   * <code>ROLE_ASSISTANT = 2 [(.mcp.client.v1.string_name) = "assistant"];</code>
   */
  ROLE_ASSISTANT(2),
  UNRECOGNIZED(-1),
  ;
  ...
  public static final com.google.protobuf.Descriptors.EnumDescriptor
      getDescriptor() {
    return org.mcp.client.resources.CommonProto.getDescriptor().getEnumTypes().get(1);
  }
  ...
  // @@protoc_insertion_point(enum_scope:mcp.client.v1.Role)
}
