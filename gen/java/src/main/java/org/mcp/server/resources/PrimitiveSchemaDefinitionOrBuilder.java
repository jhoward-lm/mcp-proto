...
public interface PrimitiveSchemaDefinitionOrBuilder extends
   ...
   */
  org.mcp.server.resources.BooleanSchema getBooleanSchema();
  /**
   * <pre>
   * Boolean schema.
   * </pre>
   ...
   * <code>.mcp.server.v1.BooleanSchema boolean_schema = 1 [json_name = "booleanSchema"];</code>
   */
  org.mcp.server.resources.BooleanSchemaOrBuilder getBooleanSchemaOrBuilder();
   ...
   */
  org.mcp.server.resources.EnumSchema getEnumSchema();
  /**
   * <pre>
   * Enum schema.
   * </pre>
   ...
   * <code>.mcp.server.v1.EnumSchema enum_schema = 2 [json_name = "enumSchema"];</code>
   */
  org.mcp.server.resources.EnumSchemaOrBuilder getEnumSchemaOrBuilder();
   ...
   */
  org.mcp.server.resources.NumberSchema getNumberSchema();
  /**
   * <pre>
   * Number schema.
   * </pre>
   ...
   * <code>.mcp.server.v1.NumberSchema number_schema = 3 [json_name = "numberSchema"];</code>
   */
  org.mcp.server.resources.NumberSchemaOrBuilder getNumberSchemaOrBuilder();
   ...
   */
  org.mcp.server.resources.StringSchema getStringSchema();
  /**
   * <pre>
   * String schema.
   * </pre>
   ...
   * <code>.mcp.server.v1.StringSchema string_schema = 4 [json_name = "stringSchema"];</code>
   */
  org.mcp.server.resources.StringSchemaOrBuilder getStringSchemaOrBuilder();

  org.mcp.server.resources.PrimitiveSchemaDefinition.DefinitionCase getDefinitionCase();
}
