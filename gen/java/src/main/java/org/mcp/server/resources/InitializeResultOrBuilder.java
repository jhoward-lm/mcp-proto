...
public interface InitializeResultOrBuilder extends
   ...
   */
  org.mcp.server.resources.ServerCapabilities getCapabilities();
  /**
   * <pre>
   * Capabilities that a server may support.
   * </pre>
   ...
   * <code>.mcp.server.v1.ServerCapabilities capabilities = 2 [json_name = "capabilities"];</code>
   */
  org.mcp.server.resources.ServerCapabilitiesOrBuilder getCapabilitiesOrBuilder();
   ...
   */
  org.mcp.server.resources.Implementation getServerInfo();
  /**
   * <pre>
   * Describes the name and version of the server implementation.
   * </pre>
   ...
   * <code>.mcp.server.v1.Implementation server_info = 3 [json_name = "serverInfo"];</code>
   */
  org.mcp.server.resources.ImplementationOrBuilder getServerInfoOrBuilder();
