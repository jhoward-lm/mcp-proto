...
public interface ListToolsResultOrBuilder extends
   ...
   */
  java.util.List<org.mcp.server.resources.ListToolsResult.Tool> 
      getToolsList();
  /**
   * <pre>
   * The list of available tools.
   ...
   * <code>repeated .mcp.server.v1.ListToolsResult.Tool tools = 2 [json_name = "tools"];</code>
   */
  org.mcp.server.resources.ListToolsResult.Tool getTools(int index);
  /**
   * <pre>
   * The list of available tools.
   * </pre>
   ...
   * <code>repeated .mcp.server.v1.ListToolsResult.Tool tools = 2 [json_name = "tools"];</code>
   */
  java.util.List<? extends org.mcp.server.resources.ListToolsResult.ToolOrBuilder> 
   ...
   * <code>repeated .mcp.server.v1.ListToolsResult.Tool tools = 2 [json_name = "tools"];</code>
   */
  org.mcp.server.resources.ListToolsResult.ToolOrBuilder getToolsOrBuilder(
      int index);
}
