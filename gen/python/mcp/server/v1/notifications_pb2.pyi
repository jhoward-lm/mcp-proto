...
class LoggingMessageNotification(_message.Message):
    __slots__ = ("method", "params")
    class Params(_message.Message):
        ...
        def __init__(self, level: _Optional[_Union[_common_pb2.LoggingLevel, str]] = ..., logger: _Optional[str] = ..., data: _Optional[_Union[_struct_pb2.Value, _Mapping]] = ...) -> None: ...
    METHOD_FIELD_NUMBER: _ClassVar[int]
    PARAMS_FIELD_NUMBER: _ClassVar[int]
    method: str
    params: LoggingMessageNotification.Params
    def __init__(self, method: _Optional[str] = ..., params: _Optional[_Union[LoggingMessageNotification.Params, _Mapping]] = ...) -> None: ...
...
class PromptListChangedNotification(_message.Message):
    __slots__ = ("method",)
    METHOD_FIELD_NUMBER: _ClassVar[int]
    method: str
    def __init__(self, method: _Optional[str] = ...) -> None: ...

class ResourceListChangedNotification(_message.Message):
    __slots__ = ("method",)
    METHOD_FIELD_NUMBER: _ClassVar[int]
    method: str
    def __init__(self, method: _Optional[str] = ...) -> None: ...

class ResourceUpdatedNotification(_message.Message):
    __slots__ = ("method", "params")
    class Params(_message.Message):
        __slots__ = ("uri",)
    ...
    def __init__(self, method: _Optional[str] = ..., params: _Optional[_Union[ResourceUpdatedNotification.Params, _Mapping]] = ...) -> None: ...

class ToolListChangedNotification(_message.Message):
    __slots__ = ("method",)
    METHOD_FIELD_NUMBER: _ClassVar[int]
    method: str
    def __init__(self, method: _Optional[str] = ...) -> None: ...
